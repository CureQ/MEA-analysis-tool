...
def network_burst_detection(outputpath, wells, electrode_amnt, measurements, hertz, min_channels, threshold_method, plot_electrodes, save_figures, savedata=True):
